...
class ModelArgs:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--csv_file_data_full', type=str, help='Path to full original data', default="data.csv")
        self.parser.add_argument('--csv_file_imputation_data', type=str, help='Path to data which should be imputed', default="imputation_data.csv")
        self.parser.add_argument('--csv_file_data', type=str, help='Name of data file', required=False, default="masked_data.csv")
        self.parser.add_argument('--csv_file_train_data', type=str, help='Name of train data file', required=False, default="masked_data_train.csv")
        self.parser.add_argument('--csv_file_test_data', type=str, help='Name of test data file', required=False, default="masked_data_test.csv")
        self.parser.add_argument('--csv_file_label', type=str, help='Name of label file', required=False, default="labels.csv")
        self.parser.add_argument('--csv_file_train_label', type=str, help='Name of train label file', required=False, default="labels_train.csv")
        self.parser.add_argument('--csv_file_test_label', type=str, help='Name of test label file', required=False, default="labels_test.csv")
        self.parser.add_argument('--csv_file_prediction_data', type=str, help='Name of prediction data file', required=False, default="masked_data_prediction.csv")
        self.parser.add_argument('--csv_file_prediction_label', type=str, help='Name of prediction label file', required=False, default="labels_prediction.csv")
        self.parser.add_argument('--csv_file_train_prediction_data', type=str, help='Name of prediction-train data file',required=False, default="masked_data_train_prediction.csv")
        self.parser.add_argument('--csv_file_train_prediction_label', type=str, help='Name of prediction-train label file',required=False, default="labels_train_prediction.csv")
        self.parser.add_argument('--csv_file_validation_data', type=str, help='Name of validation data file', required=False, default="masked_data_validation.csv")
        self.parser.add_argument('--csv_file_validation_label', type=str, help='Name of validation label file', required=False, default="labels_validation.csv")
        self.parser.add_argument('--csv_file_generation_data', type=str, help='Name of data file for image generation', required=False, default="masked_data_generation.csv")
        self.parser.add_argument('--csv_file_generation_label', type=str, help='Name of label file for image generation', required=False, default="labels_generation.csv")
        self.parser.add_argument('--mask_file', type=str, help='Name of mask file', default="mask.csv")
        self.parser.add_argument('--train_mask_file', type=str, help='Name of train mask file', default="mask_train.csv")
        self.parser.add_argument('--test_mask_file', type=str, help='Name of test mask file', default="mask_test.csv")
        self.parser.add_argument('--prediction_mask_file', type=str, help='Name of prediction mask file', default="mask_prediction.csv")
        self.parser.add_argument('--train_prediction_mask_file', type=str, help='Name of prediction mask file',default="mask_train_prediction.csv")
        self.parser.add_argument('--validation_mask_file', type=str, help='Name of validation mask file', default="mask_validation.csv")
        self.parser.add_argument('--generation_mask_file', type=str, help='Name of mask file for image generation', default="mask_generation,csv")
        self.parser.add_argument('--split_data', type=str2bool, help='bool variable if to split data into train, val,predict', default=False)
        self.parser.add_argument('--continue_training', type=str2bool, help='bool variable if to split data into train, val,predict', default=False)
        self.parser.add_argument('--num_val_instances', type=int, help='number of validation instances',default=5)
        self.parser.add_argument('--num_predict_instances', type=int, help='number of instances for prediction', default=5)
        ...
        self.parser.add_argument('--latent_dim_zy', type=int, default=2, help='Number of latent dimensions for zy')
        self.parser.add_argument('--latent_dim_zm', type=int, default=2, help='Number of latent dimensions for zm')
        ...
        self.parser.add_argument('--M_y', type=int, help='Number of inducing points for zy')
        self.parser.add_argument('--M_m', type=int, help='Number of inducing points for zm')
        ...
        self.parser.add_argument('--run_imputation', type=str2bool, default=False,
                                 help='Perform imputation using the trained model')
        ...
        self.parser.add_argument('--subjects_per_batch_tpp', type=int, default=5, help='Number of subjects per batch in mini-batching for tpp.')
        ...
        self.parser.add_argument('--LVAE_MNAR_full', type=str2bool, default=True, help='Use LVAE-MNAR full model')
        self.parser.add_argument('--D', type=int, default=15, help='Number of previous timestamps')
        self.parser.add_argument('--M_lambda', type=int, default=120, help='Number of inducing points for z lambda')
        self.parser.add_argument('--disease_covariate', type=int, default=4, help='index of disease covariate')
